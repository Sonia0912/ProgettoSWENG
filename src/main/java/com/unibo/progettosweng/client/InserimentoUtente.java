...
public class InserimentoUtente implements Pagina{
    ...
    private final UtenteServiceAsync usa = GWT.create(UtenteService.class);
    ...
    private void createForm(){
        ...
        nuovoUtente.addSubmitCompleteHandler(new FormPanel.SubmitCompleteHandler() {
            ...
            public void onSubmitComplete(FormPanel.SubmitCompleteEvent submitCompleteEvent) {
                ...
                String [] info ={nome.getText(),cognome.getText(),email.getText(),"123",tipo.getSelectedItemText()};
                usa.add(info, new AsyncCallback<String>() {
                @Override
                public void onFailure(Throwable throwable) {
                    Window.alert("fallimento: " + throwable.getMessage());
                }
                @Override
                public void onSuccess(String s) {
                    Window.alert("Successo " + s);
