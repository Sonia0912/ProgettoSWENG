...
public class Homepage implements Pagina {
    ...
    final static String[] numeriContatore = new String[4];
    ...
    public void aggiungiContenuto() throws Exception {
        ...
        serviceUtente.getUtenti(new AsyncCallback<Utente[]>() {
            ...
            public void onSuccess(Utente[] utenti) {
                ...
                String numStudenti = String.valueOf(countStud);
                ...
                try {
                    serviceCorso.getNumeroCorsi(new AsyncCallback<Integer>() {
                        ...
                        public void onSuccess(Integer n) {
                            String numCorsi = String.valueOf(n);
                            ...
                            // Quattro pannelli verticali colorati
                            HorizontalPanel hPanel4Sezioni = new HorizontalPanel();
                            hPanel4Sezioni.addStyleName("hPanel4Sezioni");
                            HTML sezione1 = new HTML("<img class=\"iconaSezione\" src=\"img/iconaCappello.png\" /><div class=\"titoloSezione\">"+ titoliSezioni[0] + "</div><div class=\"linea\"></div><div class=\"paragrafoSezione\">" + paragrafiSezioni[0] + "</div>");
                            HTML sezione2 = new HTML("<img class=\"iconaSezione\" src=\"img/iconaLampadina.png\" /><div class=\"titoloSezione\">"+ titoliSezioni[1] + "</div><div class=\"linea\"></div><div class=\"paragrafoSezione\">" + paragrafiSezioni[1] + "</div>");
                            HTML sezione3 = new HTML("<img class=\"iconaSezione\" src=\"img/iconaCalendario.png\" /><div class=\"titoloSezione\">"+ titoliSezioni[2] + "</div><div class=\"linea\"></div><div class=\"paragrafoSezione\">" + paragrafiSezioni[2] + "</div>");
                            HTML sezione4 = new HTML("<img class=\"iconaSezione\" src=\"img/iconaMappa.png\" /><div class=\"titoloSezione\">"+ titoliSezioni[3] + "</div><div class=\"linea\"></div><div class=\"paragrafoSezione\">" + paragrafiSezioni[3] + "</div>");
                            ...
                            String numDipartimenti = "5";
                            hPanelCifre.add(new HTML("<div class=\"contatore\"><div class=\"contatoreColonne\"><img class=\"iconaContatore\" src=\"img/iconaStudenti.png\" /><div class=\"colonnaNumeri\"><div class=\"numeroContatore\">" + numStudenti + "</div><div class=\"titoloContatore\">" + titoloContatore[0] + "</div></div></div></div>"));
                            hPanelCifre.add(new HTML("<div class=\"contatore\"><div class=\"contatoreColonne\"><img class=\"iconaContatore\" src=\"img/iconaCorsi.png\" /><div class=\"colonnaNumeri\"><div class=\"numeroContatore\">" + numCorsi + "</div><div class=\"titoloContatore\">" + titoloContatore[1] + "</div></div></div></div>"));
                            hPanelCifre.add(new HTML("<div class=\"contatore\"><div class=\"contatoreColonne\"><img class=\"iconaContatore\" src=\"img/iconaDipartimenti.png\" /><div class=\"colonnaNumeri\"><div class=\"numeroContatore\">" + numDipartimenti + "</div><div class=\"titoloContatore\">" + titoloContatore[2] + "</div></div></div></div>"));
                            hPanelCifre.add(new HTML("<div class=\"contatore\"><div class=\"contatoreColonne\"><img class=\"iconaContatore\" src=\"img/iconaProfessore.png\" /><div class=\"colonnaNumeri\"><div class=\"numeroContatore\">" + numDocenti + "</div><div class=\"titoloContatore\">" + titoloContatore[3] + "</div></div></div></div>"));
