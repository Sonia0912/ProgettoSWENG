...
public class PortaleStudente extends Portale {
    ...
    private static ArrayList<Corso> CORSI = new ArrayList<Corso>(Arrays.asList(
            new Corso("Sistemi Operativi", "24/04/2022", "06/06/2022", "Un corso sull'informatica.", "doc"),
    ...
    private static List<Corso> TUTTICORSI = Arrays.asList(
        new Corso("Sistemi Operativi", "24/04/2022", "06/06/2022", "Un corso sull'informatica.","doc"),
        new Corso("Analisi I", "26/04/2022", "15/06/2022", "Logaritmi e derivate.", "cod"),
        new Corso("Basi di dati", "13/11/2022", "15/02/2023", "Impareremo i database relazionali e non.","doc"),
        new Corso("Fisica nucleare", "26/04/2022", "15/06/2022", "Dagli atomi all'universo.", "doc"),
        new Corso("Chimica applicata", "17/02/2022", "29/03/2022", "Lezioni di chimica applicata.","doc"),
        new Corso("Algebra lineare", "12/03/2022", "17/05/2022", "Tutto sulle matrici.", "doc")
    );
