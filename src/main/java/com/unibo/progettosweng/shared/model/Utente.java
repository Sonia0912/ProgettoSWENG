...
import com.unibo.progettosweng.shared.SerializerUtente;
import org.mapdb.DB;
...
public class Utente /*implements OperazioniDB<Utente>*/ {
    ...
    public Utente crea(String nome, String cognome, String username, String password, String tipo){
        return new Utente( nome,  cognome,  username,  password,  tipo);
    }
